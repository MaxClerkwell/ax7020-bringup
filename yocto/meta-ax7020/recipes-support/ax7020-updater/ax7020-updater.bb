...
SRC_URI = "file://ax7020-update file://ax7020-update.conf file://ax7020-update.init"
...
FILES:${PN} = "${bindir}/ax7020-update ${sysconfdir}/ax7020-update.conf ${sysconfdir}/init.d/ax7020-update"
