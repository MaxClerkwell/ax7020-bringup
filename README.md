...
The clean path through the whole project as one document, English and
Simplified Chinese, with checkpoints after every step and no detours:
[`tutorial/`](tutorial/) — PDFs, LaTeX sources and a Makefile. Licensed
CC BY 4.0. The article series with all the detours is at
<https://maxclerkwell.tech/alinx/>.
